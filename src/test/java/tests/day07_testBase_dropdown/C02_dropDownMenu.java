...
public class C02_dropDownMenu extends TestBase {
    ...
    public void test01(){
        ...
        // dropdown menu locate et
        WebElement dropDownMenuElementi= driver.findElement(By.id("searchDropdownBox"));
        //select sınııfndan bir obje oluştur
        Select select=new Select(dropDownMenuElementi);
        int expectedOptionsayisi=28;
         int actualOptıonSayisi=select.getOptions().size();
        Assert.assertEquals(expectedOptionsayisi,actualOptıonSayisi);
        ...
        // bulunan sonuc sayisinin 7'dan fazla oldugunu test edin
        String sonucYazisi = driver.findElement(By.xpath("//h1[@class='a-size-base s-desktop-toolbar a-text-normal']")).getText();
       String sonucYazisiElementi=sonucYazisi.substring(0,sonucYazisi.indexOf(" "));
        ...
        Assert.assertTrue(sonucSayisiInt>7);
