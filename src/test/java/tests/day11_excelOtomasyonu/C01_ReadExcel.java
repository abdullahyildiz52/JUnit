...
public class C01_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        // String olan expectedBaskentIsmi ile Cell olan ingilizceBaskent karşılaştırılamaz bu nendenle
        // ingilizceBaskent Stringe çevrilmeli
        String actualBaskentIsmi= ingilizceBaskent.toString();

        Assert.assertEquals(expectedBaskentIsmi,actualBaskentIsmi);
        System.out.println(actualBaskentIsmi);
